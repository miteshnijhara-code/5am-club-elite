  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans">
      <nav className="p-6 flex justify-between items-center border-b border-gray-900">
        ...
        <a href="/login" className="text-sm uppercase tracking-widest border px-4 py-2 hover:bg-white hover:text-black transition-colors">Member Login</a>
      </nav>

      <main className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-7xl md:text-9xl font-black mb-8 leading-none">THE PROTOCOL.</h1>
        <p className="text-2xl text-gray-400 mb-8">20 days. 5 AM. No excuses. If you miss, you&apos;re out.</p>
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <p className="text-gray-500 max-w-lg">
            Our members aren&apos;t just waking up. They are engineering their careers, fitness, and mental clarity through our proprietary 20-day streak engine.
          </p>
        </div>
      </main>
    </div>
